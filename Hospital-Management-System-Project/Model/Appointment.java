...
public class Appointment implements Displayable, StatusManageable {
    ...
    /**
     * Displays full appointment information in a formatted manner
    ...
    /**
     * Returns a brief summary of the appointment
     * Implements Displayable interface
    ...
    public String getSummary() {
        ...
        return getId() + " | " + patientName + " with " + doctorName + " | " + getStatusDisplay();
    }
